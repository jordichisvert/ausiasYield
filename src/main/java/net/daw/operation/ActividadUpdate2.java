...
public class ActividadUpdate2 {
      public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            throw new ServletException("Controller: Update Error: Phase 2: " + e.getMessage());
        }
        return "Se ha modificado la información del actividad con id=" + Integer.toString(oActividadBean.getId());
    }
}
